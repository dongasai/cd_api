...
return [
    'fields' => [
        ...
        'allowed_groups' => '允许的分组',
        'not_allowed_groups' => '禁止的分组',
        'allowed_tags' => '允许的标签',
        'not_allowed_tags' => '禁止的标签',
        'rate_limit' => '速率限制',
        'expires_at' => '过期时间',
        'last_used_at' => '最后使用时间',
        'created_at' => '创建时间',
    ...
    'labels' => [
        ...
        'allowed_groups_help' => '分组白名单：渠道必须属于这些分组之一才能访问，留空表示不限制',
        'not_allowed_groups_help' => '分组黑名单：属于这些分组的渠道禁止访问',
        'allowed_tags_help' => '标签白名单：渠道必须拥有这些标签之一才能访问，留空表示不限制',
        'not_allowed_tags_help' => '标签黑名单：拥有这些标签的渠道禁止访问',
