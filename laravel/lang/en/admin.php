...
return [
    ...
    'avatar' => 'Avatar',
    'language' => 'Language',
    'language_help' => 'Select your preferred interface language. Refresh the page after saving to take effect.',
    'list' => 'List',
    'new' => 'New',
    'create' => 'Create',
    'delete' => 'Delete',
    ...
    // 菜单标题中英文映射 (Dcat Admin 会自动查找 menu.titles.xxx 格式)
    'menu' => [
        'titles' => [
            'dashboard' => 'Dashboard',
            'api_keys' => 'API Keys',
            ...
            'model_test_old' => 'Legacy Test',
            'model_test_openai' => 'OpenAI UI',
            'system' => 'System',
